<div id="my-budget" class="mx-6 mt-6">
    ...
    <div id="budget-container" class="flex flex-row">
      <div id="add-budget-button" class="flex flex-col justify-center">
          <svg class="cursor-pointer" id="add-icon" xmlns="http://www.w3.org/2000/svg" height="32" width="28" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.-->

...
<div class="h-28 aspect-video bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
    <p class="m-4 font-normal text-gray-700 dark:text-gray-400">Budget Item Name</p>
    <p class="m-4 text-xl font-bold tracking-tight text-gray-900 dark:text-white">KES 10000</p>
